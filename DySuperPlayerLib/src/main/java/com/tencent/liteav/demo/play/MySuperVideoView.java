...
public class MySuperVideoView extends RelativeLayout implements ITXVodPlayListener, ITXLivePlayListener {
    ...
    public void onPlayEvent(TXVodPlayer player, int event, Bundle param) {
        ...
        if(event==2007){
            long progress = (long) (mVodPlayer.getPlayableDuration()*1000);
        ...
        Log.d("SuperPlayerView", "当前状态："+event);
        if (event == 2013) {
