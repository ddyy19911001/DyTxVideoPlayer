...
public class ScreenSwitchUtils {
    ...
    public interface OnOritationChangeListener{
        void onOritationChange(int orientation);
    }

    OnOritationChangeListener changeListener;

    public void setListener(OnOritationChangeListener listener) {
            ...
            switch (msg.what) {
                case 888:
                    ...
                    if(changeListener!=null){
                        changeListener.onOritationChange(orientation);
                    }
                    break;
                default:
                    break;
