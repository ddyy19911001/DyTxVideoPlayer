...
public class TCVodControllerLarge extends TCVodControllerBase implements OnClickListener, TCVodMoreView.Callback, TCVodQualityView.Callback, OnSeekBarPointClickListener {
    ...
    private ImageView mIvTo15;
    private ImageView mIvBack15;
    ...
    private void initViews(Context context) {
        ...
        this.mIvTo15 = (ImageView)this.findViewById(id.iv_to_15);
        this.mIvBack15 = (ImageView)this.findViewById(id.iv_back_15);
        this.mIvVoice = (ImageView)this.findViewById(id.iv_voice);
        ...
        this.mIvBack15.setOnClickListener(this);
        this.mIvTo15.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        if (i != id.iv_back && i != id.tv_title&&i!= id.iv_fullscreen) {
            if (i == id.iv_pause) {
                ...
                this.backToLive();
            }else if(i==id.iv_back_15){
                float nowPlayedTime = mVodController.getCurrentPlaybackTime();
                float needPlayTime=nowPlayedTime-15;
                if(needPlayTime<=0){
                    needPlayTime=0;
                }
                mVodController.seekTo((int) needPlayTime);
                mVodController.resume();
            }else if(i==id.iv_to_15){
                float nowPlayedTime = mVodController.getCurrentPlaybackTime();
                mVodController.seekTo((int) (15+nowPlayedTime));
                mVodController.resume();
            }else if(i==id.iv_voice){
                switchVoice(mContext,this.mIvVoice);
            }else if(i==id.tv_speed){
                showSpeedPop((Activity) mContext, mTvSpeed,onRateCheckedListener,true);
            }
        } else {
